    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Data A <i class="fa fa-fw fa-caret-down"></i></a>
            <ul id="demo" class="collapse">
            <li>
            <a href="hujan.php">Data Hujan</a>
            </li>
             <li>
            <a href="fklim.php">Data FKLIM</a>
            </li>
            <li>
            <a href="data3.php">Data ARG</a>
            </li>
            <li>
            <a href="data4.php">Data AWS</a>
           
            <li>
            <a href="data4.php">Data AAWS</a>
             </li>
              </ul>

<?php include("config.php");
          ...
          $id=$_GET['id'];
           $query = mysqli_query($conn,"SELECT * FROM kabupaten INNER JOIN data_hujan ON data_hujan.id_kabupaten = kabupaten.nama_kabupaten WHERE kabupaten.id_kabupaten = '$id'");
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          echo '<li><a href="hapus.php" onclick="return confirm(\'Yakin?\')">Delete</a></li>';
  ...
  <div class="container container-body">
    <h1>Upload Data <?= $row_query['nama_kabupaten'];?></h1>
    <hr>
    <?php
    if(!$_SESSION['user']){
      ...
      <div class="col-md-6 col-md-offset-3">
        ...
        <?php
          ...
          $success = move_uploaded_file($myFile["tmp_name"],
            ...
            $insert = $conn->query("INSERT INTO data_hujan(id_kabupaten, tgl_upload, file_name, file_size, file_type) VALUES('$idk', '$tgl', '$name', '$size', '$ext')");
...
<div class="container container-body">
  <?php
        $id=$_GET['id']; 
        $query = mysqli_query($conn,"SELECT * FROM kabupaten where id_kabupaten='$id'");
  ...
  ?>
    ...
    <table class="table table-striped table-hover order-table ">
      ...
      $sql = $conn->query("SELECT * FROM data_hujan where id_kabupaten='$id'");
      ...
      if($sql->num_rows > 0){
        ...
        while($row = $sql->fetch_assoc()){
          echo '
           ...
           <td><a href="hapus.php?id='.$row['id'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Ongguen?\')"> Delete</a></td>

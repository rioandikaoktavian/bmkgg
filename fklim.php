<?php 
  ...
  $query = mysqli_query($conn, "SELECT * FROM fklim ORDER BY id_fiklim DESC");
...
<body>
  ...
  <div class="container container-body">
   <h1><p style="font-family: Franklin Gothic Heavy" align="center" >Data Fklim</h1>
<center> <input type="search" class="light-table-filter " data-table="order-table" placeholder="cari"/></center><br>
  <table class="rainbow-table order-table" align="center" >
    <thead>
      <tr>
        <th bgcolor="gray" height="40px" >Data Fklim</th>
        <th bgcolor="gray">Buka</th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td width="300px" height="50px"><?= $data['data_fklim'];?></td>
        <td><a href="detailfiklim.php?id=<?php echo $data['id_fiklim'];?>"><button class="a"> Buka </button></td></a>
      </tr>
